    ...
    try {
      const res = await fetch(`${API_BASE_URL}/api/explain`, {
        ...
        body: JSON.stringify({
          ...
          flashcardCount: flashcardCountOverride,
          quizQuestionCount: quizCountOverride,
          performanceSignals,
        }),
      });
      const data = await res.json();
    ...
    <div className="app-shell">
      ...
      <div className="page-frame">
        ...
        <section className="stats-strip">
          {quickStats.map((item) => <StatCard key={item.label} value={item.value} label={item.label} detail={item.detail} />)}
        </section>
...
.brand-chip{width:66px;height:66px;border-radius:22px;background:linear-gradient(180deg,var(--panel-2) 0%,var(--panel) 100%);display:grid;place-items:center}.brand-title{font-size:34px;font-weight:900;line-height:1;font-family:'Baloo 2',cursive}.brand-subtitle{color:var(--muted);font-size:14px}.brand-wrap-polished{align-items:center;gap:14px}.streak-badge{display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:999px;background:rgba(255,255,255,.05);border:1px solid var(--line);color:var(--muted);font-size:12px;font-weight:800}.polished-topbar{margin-bottom:18px}.auth-button,.theme-toggle{border-radius:999px;background:var(--panel);color:var(--text);padding:12px 18px;display:flex;gap:18px;align-items:center;cursor:pointer;font-weight:800}.auth-button{background:var(--panel-3)}
.hero-copy,.hero-mascot-card,.panel{background:linear-gradient(180deg,var(--panel-2) 0%,var(--panel) 100%);border-radius:28px;padding:26px;position:relative}.stats-strip{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin:20px 0 12px}.polished-stat-card strong{color:#4df28d}.polished-stat-card{background:linear-gradient(180deg,var(--panel-2) 0%,var(--panel) 100%)}.hero-copy{flex:1.2;min-width:0}.hero-copy h1{margin:12px 0 14px;font-size:clamp(40px,5vw,66px);line-height:1;font-family:'Baloo 2',cursive}.hero-copy p,.slide-card p,.mode-card p,.question-box,.coach-response p,.library-card p{color:var(--muted);line-height:1.7}.hero-mascot-card{flex:.8;min-width:320px;display:flex;flex-direction:column;align-items:center;justify-content:space-between;text-align:center}
.mascot-badge,.pill,.eyebrow,.field-label{text-transform:uppercase;letter-spacing:.16em;font-size:11px;font-weight:900}.mascot-badge,.pill{background:rgba(255,255,255,.06);color:var(--text);border-radius:999px;padding:10px 14px}.pill-green{background:rgba(88,204,2,.18)}.pill-blue{background:rgba(102,169,255,.18)}.hero-stats{margin-top:24px;flex-wrap:wrap}.stat-card{min-width:120px;border-radius:24px;background:var(--panel-3);padding:18px}.stat-card strong{display:block;font-size:30px;font-weight:900}.stat-card span{display:block;color:var(--text);margin-top:6px;font-weight:800}.stat-card small{display:block;color:var(--muted);margin-top:8px;line-height:1.5}.mascot-caption{display:grid;gap:6px;margin-top:10px}.mascot-caption span{color:var(--muted);line-height:1.6}
.panel{margin-top:22px}.section-heading{margin-bottom:18px}.section-heading h2{margin:8px 0 0;font-size:32px;font-family:'Baloo 2',cursive}.support-copy{margin:0;color:var(--muted);line-height:1.7}.eyebrow,.field-label{color:var(--muted)}.grid.two-up{grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.grid.three-up{grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.field-wrap{display:grid;gap:8px}.embedded-level-grid{margin-bottom:18px}.count-picker{display:grid;gap:8px;margin-top:18px}.count-picker span{font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--muted)}.revision-open{margin-top:18px;width:100%}
...
.error-banner{margin-top:18px;background:rgba(255,107,107,.14);border-radius:18px;padding:16px 18px;color:#ffdede}.lesson-stack{display:grid;gap:22px}.lesson-overview-grid{display:grid;grid-template-columns:minmax(0,2.15fr) minmax(260px,.85fr);gap:18px}.lesson-hero{display:flex;justify-content:space-between;gap:20px;align-items:start}.lesson-hero-main{min-height:210px}.lesson-hero h2{margin:8px 0 10px;font-size:44px;font-family:'Baloo 2',cursive}.hero-mascot-inline{display:flex;align-items:flex-end;justify-content:center;min-width:180px}.snapshot-card{min-width:220px;border-radius:24px;background:var(--panel-3);padding:18px}.snapshot-card-hero{display:flex;flex-direction:column;align-items:center;text-align:center;gap:10px}.snapshot-avatar{width:64px;height:64px;border-radius:999px;display:grid;place-items:center;background:rgba(255,255,255,.05);border:1px solid var(--line)}.snapshot-name{font-size:18px}.snapshot-line{display:flex;justify-content:space-between;margin-top:10px;gap:12px;width:100%}.snapshot-line span{color:var(--muted)}.live-eyebrow{display:flex;align-items:center;gap:8px}.live-dot{width:10px;height:10px;border-radius:999px;background:#4df28d;box-shadow:0 0 0 0 rgba(77,242,141,.6);animation:pulseGlow 1.8s infinite}.hero-actions .cta-button{min-width:170px}
.tabs{flex-wrap:wrap;margin-bottom:16px}.tab{border:2px solid var(--line);background:var(--panel-3);color:var(--text);border-radius:18px;padding:12px 14px;display:flex;align-items:center;gap:10px;cursor:pointer;transition:transform .2s ease, opacity .2s ease, border-color .2s ease}.tab.active{background:rgba(88,204,2,.14)}.tab:hover{transform:translateY(-2px);border-color:rgba(88,204,2,.4)}.tab small{color:var(--muted);display:block}.dot{width:12px;height:12px;border-radius:999px}.explanation-card{border-width:2px;border-style:solid;border-radius:26px;background:var(--panel-3);padding:24px}.animated-explanation{animation:fadeSlide .35s ease}.explanation-card.long-form p{margin:10px 0 0;color:var(--text);line-height:2.05;font-size:18px;white-space:pre-wrap}.mode-card,.slide-card,.flashcard,.quiz-question,.insight-panel{border-radius:24px;background:linear-gradient(180deg,var(--panel-2) 0%,var(--panel) 100%);padding:22px}.polished-lenses .mode-card{transition:transform .18s ease, box-shadow .18s ease, border-color .18s ease}.polished-lenses .mode-card:hover{transform:translateY(-6px);box-shadow:0 18px 40px rgba(88,204,2,.14);border-color:rgba(88,204,2,.36)}
.slide-shell{align-items:stretch}.slide-card{flex:1;min-height:420px;display:flex;flex-direction:column;justify-content:center;padding:38px}.slide-card h3{font-family:'Baloo 2',cursive;font-size:52px;margin:0 0 18px}.slide-card p{font-size:22px;color:var(--text);line-height:2}.slide-progress{color:var(--sun);font-weight:900;text-transform:uppercase;letter-spacing:.14em;margin-bottom:12px}.progress-dots{flex-wrap:wrap;margin-top:14px}.progress-dot{background:var(--panel-3);border-bottom-color:rgba(255,255,255,.18);padding:10px 14px}.progress-dot.active{background:var(--lime)}
...
.coach-response{margin-top:20px;border-radius:24px;background:rgba(88,204,2,.12);padding:18px}.coach-response small{color:var(--muted)}.quiz-summary-card{background:rgba(124,184,255,.12)}.teachback-grid{margin-top:16px}.eggzy{width:260px;max-width:100%;animation:floatBob 3.6s ease-in-out infinite}.eggzy.compact{width:42px;animation:none}@keyframes fadeSlide{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:translateY(0)}}@keyframes pulseGlow{0%{transform:scale(1);box-shadow:0 0 0 0 rgba(77,242,141,.6)}70%{transform:scale(1.05);box-shadow:0 0 0 10px rgba(77,242,141,0)}100%{transform:scale(1)}}@keyframes floatBob{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}
@media (max-width:1080px){.stats-strip,.grid.three-up,.quiz-options,.level-grid,.grid.two-up,.teachback-grid,.choice-grid,.dashboard-grid,.lesson-overview-grid{grid-template-columns:1fr}.hero-panel,.lesson-hero,.slide-shell,.quiz-strip-copy{flex-direction:column}.nav-arrow{width:100%}.slide-card{min-height:320px}.slide-card h3{font-size:38px}.slide-card p{font-size:18px}.hero-mascot-inline{justify-content:flex-start}}
